...
export default function LoginPage() {
    ...
    return (
        <Grid container justifyContent={"center"} alignItems={"center"} sx={{height: '100vh',backgroundPosition: 'center', backgroundImage: 'url(/bgmedium.jpg)', backgroundSize: "cover"}}>
            <Grid item xs={1}></Grid>
