...
export default function PromptCheckEmailResetPage(){
    return(
        <Grid container justifyContent={"center"} alignItems={"center"}
            ...
            <Box sx={{p: 2, bgcolor: 'white', borderRadius: '16px', boxShadow: 10, border: 1, display: 'flex', flexDirection: 'column', textAlign: 'center', justifyContent: 'center', alignItems: 'center'}}>
                ...
                <Typography sx={{mb: 2}}>We sent you an email.</Typography>
                <Typography>Follow the link in that email to reset your password.</Typography>
            </Box>
        </Grid>
    )
}